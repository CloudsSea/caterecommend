...
CREATE TABLE `business` (
	...
	`latitude` VARCHAR (12) DEFAULT '' COMMENT '维度',
	`longitude` VARCHAR (12) DEFAULT '' COMMENT '经度',
...
CREATE TABLE `bus_attribute` (
	...
	`ages_allowed` TINYINT (1) DEFAULT '0' COMMENT '年龄允许',
	`alcohol` TINYINT (1) DEFAULT '0' COMMENT '提供酒',
	`attire` TINYINT (1) DEFAULT '0' COMMENT '装饰',
	`byob` TINYINT (1) DEFAULT '0' COMMENT '自带酒',
	`byob_corkage` TINYINT (1) DEFAULT '0' COMMENT '自带酒或开瓶费',
	...
	`noise_level` TINYINT (1) DEFAULT '0' COMMENT '吵闹',
	...
	`smoking` TINYINT (1) DEFAULT '0' COMMENT '吸烟',
	...
	`wi_fi` TINYINT (1) DEFAULT '0' COMMENT 'wi_fi'
...
CREATE TABLE `bus_category` (
	`id` VARCHAR (22) NOT NULL COMMENT '商户id',
	`p_id` VARCHAR (22) DEFAULT '' COMMENT '父级id',
	`name` VARCHAR (22) DEFAULT '' COMMENT '分类名称'
...
CREATE TABLE `bus_neighborhood` (
	`business_id` VARCHAR (22) NOT NULL COMMENT '商户id',
	`id`  VARCHAR (22) DEFAULT '' COMMENT '邻居id',
